...
public class CoffeeMakerTest {
	...
	public void testMakeCoffee() {
	    ...
	    public void testEditRecipe() {
	        ...
	        editedRecipe.setName("Edited Recipe");
	        assertEquals("Test Recipe", coffeeMaker.editRecipe(0, editedRecipe));
	    }

	    @Test
	    public void testAddInventory() throws InventoryException {
	        coffeeMaker.addInventory("4", "7", "2", "0");
	    ...
	    @Test
	    public void testMakeCoffee() throws InventoryException {
	        Recipe r = new Recipe();
	        r.setName("Test Recipe");
	        r.setPrice(50);
	        r.setAmtCoffee("3");
